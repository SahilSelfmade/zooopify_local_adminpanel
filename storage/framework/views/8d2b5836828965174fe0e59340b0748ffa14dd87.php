...
} elseif ($_instance->childHasBeenRendered('KyDsLmG')) {
    $componentId = $_instance->getRenderedChildComponentId('KyDsLmG');
    $componentTag = $_instance->getRenderedChildComponentTagName('KyDsLmG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KyDsLmG');
} else {
    $response = \Livewire\Livewire::mount('component.dynamic-nav-menu', []);
    $html = $response->html();
    $_instance->logRenderedChild('KyDsLmG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
